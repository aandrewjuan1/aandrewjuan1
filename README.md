...
I’m a **Computer Science graduate** actively looking for an **entry-level full-stack or backend web developer** role. I enjoy working on real-world problems, writing maintainable code, and building web applications that are both functional and user-focused.

Most of my experience revolves around **Laravel-based backends**, modern frontend tooling, and building features end-to-end — from database design to UI interactions. I’m continuously learning, improving my workflow, and getting more comfortable with production-level codebases.
...
🌐 Portfolio: [https://aandrewjuan1.github.io/portfolio](https://aandrewjuan1.github.io/portfolio)
